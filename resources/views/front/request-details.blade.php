        ...
        <div class="path">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url(route('donation-request'))}}">طلبات التبرع</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                        طلب التبرع:احمد محمد
                    ...
                    <div class="col-md-6">
                        <div class="inside">
                            <div class="info">
                                ...
                                <div class="light">
                                    <p dir="ltr">{{$donation_request->bloodType->name}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="inside">
                            <div class="info">
                                ...
                                <div class="light">
                                    <p>{{$donation_request->hospital_phone}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
